...
from models.transformer_timm import AttentionBlock
...
class MultiModalNet(nn.Module):
    def __init__(self, num_classes, drop=0, num_heads=1):
        ...
        self.av = AttentionBlock(in_dim_k=input_dim_video, in_dim_q=input_dim_audio, out_dim=input_dim_audio, num_heads=num_heads)
        self.va = AttentionBlock(in_dim_k=input_dim_audio, in_dim_q=input_dim_video, out_dim=input_dim_video, num_heads=num_heads)
